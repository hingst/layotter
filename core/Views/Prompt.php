    ...
    public static function view() {
        ...
        <div class="layotter-modal-prompt">
            ...
            <div class="layotter-modal-prompt-buttons">
                <button type="button" class="button button-primary button-large" ng-click="prompt.okAction()">{{
                    prompt.okText }}
                </button>
                <button type="button" class="button button-large" ng-click="prompt.cancelAction()">{{ prompt.cancelText
                    }}
                </button>
            </div>
        </div>
