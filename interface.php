...
function eddditor($post) {
    ...
    if ($debug_mode_enabled) {
        ...
        echo '</p>';
        echo '<textarea id="content" name="content" style="width: 100%; height: 320px;display: block;">' . get_the_content() . '</textarea>';
    } else {
        echo '<textarea id="content" name="content" style="width: 1px; height: 1px; position: fixed; top: -999px; left: -999px;">' . get_the_content() . '</textarea>';
    }
